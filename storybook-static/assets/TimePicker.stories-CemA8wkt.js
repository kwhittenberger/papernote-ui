import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as a}from"./iframe-BGnfALfv.js";import{X as Te}from"./x-BG-wDY58.js";import{c as se}from"./createLucideIcon-CUwsy_KF.js";import{C as xe}from"./chevron-down-DJ26yXSb.js";import"./preload-helper-PPVm8Dsz.js";const be=[["path",{d:"m18 15-6-6-6 6",key:"153udz"}]],ve=se("chevron-up",be);const Se=[["path",{d:"M12 6v6l4 2",key:"mmk7yg"}],["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}]],ye=se("clock",Se),n=a.forwardRef(({value:t=null,onChange:r,label:m,placeholder:d="Select time",use12Hour:s=!1,showSeconds:u=!1,minuteStep:c=1,minTime:p,maxTime:h,validationState:l,validationMessage:f,helperText:v,required:K=!1,disabled:T=!1,className:oe="",size:X="md"},le)=>{const[P,S]=a.useState(!1),[x,Z]=a.useState(()=>ie(t,s)),G=a.useRef(null),w=a.useRef(null),ee=a.useId(),te=a.useId(),re=a.useId();a.useImperativeHandle(le,()=>({focus:()=>w.current?.focus(),blur:()=>w.current?.blur(),open:()=>S(!0),close:()=>S(!1)}));function ie(i,o){if(!i){const J=new Date;return{hours:o?J.getHours()%12||12:J.getHours(),minutes:0,seconds:0,period:o?J.getHours()>=12?"PM":"AM":void 0}}const[y,M]=i.split(" "),b=y.split(":"),g=parseInt(b[0],10),j=parseInt(b[1]||"0",10),C=parseInt(b[2]||"0",10);return o?{hours:g%12||12,minutes:j,seconds:C,period:M||(g>=12?"PM":"AM")}:{hours:g,minutes:j,seconds:C}}function me(i,o,y){let M=i.hours;return o?`${M.toString().padStart(2,"0")}:${i.minutes.toString().padStart(2,"0")}${y?":"+i.seconds.toString().padStart(2,"0"):""} ${i.period}`:`${M.toString().padStart(2,"0")}:${i.minutes.toString().padStart(2,"0")}${y?":"+i.seconds.toString().padStart(2,"0"):""}`}function ae(i){let o=i.hours;return i.period==="PM"&&o!==12?o+=12:i.period==="AM"&&o===12&&(o=0),`${o.toString().padStart(2,"0")}:${i.minutes.toString().padStart(2,"0")}${u?":"+i.seconds.toString().padStart(2,"0"):""}`}function ue(i){const o=ae(i),[y,M]=o.split(":").map(Number),b=y*60+M;if(p){const[g,j]=p.split(":").map(Number),C=g*60+j;if(b<C)return!1}if(h){const[g,j]=h.split(":").map(Number),C=g*60+j;if(b>C)return!1}return!0}const k=i=>{const o={...x,...i};Z(o),ue(o)&&r?.(ae(o))},ce=()=>{r?.(null),S(!1),w.current?.focus()};a.useEffect(()=>{const i=o=>{G.current&&!G.current.contains(o.target)&&S(!1)};return P&&document.addEventListener("mousedown",i),()=>{document.removeEventListener("mousedown",i)}},[P]),a.useEffect(()=>{Z(ie(t,s))},[t,s]);const de={sm:"text-sm py-1.5 px-3",md:"text-sm py-2 px-3",lg:"text-base py-2.5 px-4"},ne={sm:"h-4 w-4",md:"h-4 w-4",lg:"h-5 w-5"},pe={error:"border-error-500 focus:ring-error-500 focus:border-error-500",success:"border-success-500 focus:ring-success-500 focus:border-success-500",warning:"border-warning-500 focus:ring-warning-500 focus:border-warning-500"},fe={error:"text-error-600",success:"text-success-600",warning:"text-warning-600"},he=t?me(x,s,u):"",ge=Array.from({length:60/c},(i,o)=>o*c);return e.jsxs("div",{className:`relative ${oe}`,ref:G,children:[m&&e.jsxs("label",{id:ee,className:"block text-sm font-medium text-ink-700 mb-1",children:[m,K&&e.jsx("span",{className:"text-error-500 ml-1",children:"*"})]}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{ref:w,type:"text",value:he,onClick:()=>!T&&S(!0),onFocus:()=>!T&&S(!0),placeholder:d,disabled:T,readOnly:!0,className:`
            w-full rounded-md border bg-white cursor-pointer
            ${de[X]}
            ${l?pe[l]:"border-paper-300 focus:ring-primary-500 focus:border-primary-500"}
            ${T?"bg-paper-100 text-ink-400 cursor-not-allowed":""}
            focus:outline-none focus:ring-2
            pr-20
          `,"aria-labelledby":m?ee:void 0,"aria-label":m?void 0:"Time picker","aria-expanded":P,"aria-haspopup":"dialog","aria-controls":te,"aria-invalid":l==="error"?"true":void 0,"aria-describedby":f?re:void 0,role:"combobox"}),e.jsxs("div",{className:"absolute inset-y-0 right-0 flex items-center pr-2 gap-1",children:[t&&!T&&e.jsx("button",{type:"button",onClick:i=>{i.stopPropagation(),ce()},className:"p-0.5 text-ink-400 hover:text-ink-600 focus:outline-none","aria-label":"Clear",tabIndex:-1,children:e.jsx(Te,{className:ne[X]})}),e.jsx(ye,{className:`${ne[X]} text-ink-400`})]})]}),f&&e.jsx("p",{id:re,className:`mt-1 text-xs ${l?fe[l]:"text-ink-500"}`,role:"alert","aria-live":"polite",children:f}),v&&!f&&e.jsx("p",{className:"mt-1 text-xs text-ink-500",children:v}),P&&e.jsx("div",{id:te,className:"absolute z-50 mt-1 bg-white rounded-md shadow-lg border border-paper-200",role:"dialog","aria-modal":"true","aria-label":"Time selection",children:e.jsxs("div",{className:"p-4 flex items-center gap-4",children:[e.jsx(Q,{value:x.hours,min:s?1:0,max:s?12:23,onChange:i=>k({hours:i}),label:"Hour"}),e.jsx("span",{className:"text-2xl font-bold text-ink-600",children:":"}),e.jsx(Q,{value:x.minutes,min:0,max:59,step:c,options:ge,onChange:i=>k({minutes:i}),label:"Min"}),u&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"text-2xl font-bold text-ink-600",children:":"}),e.jsx(Q,{value:x.seconds,min:0,max:59,onChange:i=>k({seconds:i}),label:"Sec"})]}),s&&e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("button",{type:"button",onClick:()=>k({period:"AM"}),className:`
                    px-3 py-1 text-sm font-medium rounded
                    ${x.period==="AM"?"bg-primary-500 text-white":"bg-paper-100 text-ink-600 hover:bg-paper-200"}
                  `,children:"AM"}),e.jsx("button",{type:"button",onClick:()=>k({period:"PM"}),className:`
                    px-3 py-1 text-sm font-medium rounded
                    ${x.period==="PM"?"bg-primary-500 text-white":"bg-paper-100 text-ink-600 hover:bg-paper-200"}
                  `,children:"PM"})]})]})})]})});n.displayName="TimePicker";function Q({value:t,min:r,max:m,step:d=1,options:s,onChange:u,label:c}){const p=()=>{if(s){const f=(s.indexOf(t)+1)%s.length;u(s[f])}else{const l=t+d;u(l>m?r:l)}},h=()=>{if(s){const l=s.indexOf(t),f=l-1<0?s.length-1:l-1;u(s[f])}else{const l=t-d;u(l<r?m:l)}};return e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx("button",{type:"button",onClick:p,className:"p-1 text-ink-600 hover:bg-paper-100 rounded","aria-label":`Increase ${c}`,children:e.jsx(ve,{className:"h-4 w-4"})}),e.jsx("div",{className:"w-12 text-center",children:e.jsx("input",{type:"text",value:t.toString().padStart(2,"0"),readOnly:!0,className:"w-full text-center text-2xl font-bold text-ink-900 bg-transparent border-none focus:outline-none","aria-label":c})}),e.jsx("button",{type:"button",onClick:h,className:"p-1 text-ink-600 hover:bg-paper-100 rounded","aria-label":`Decrease ${c}`,children:e.jsx(xe,{className:"h-4 w-4"})})]})}try{n.displayName="TimePicker",n.__docgenInfo={description:`TimePicker component - Time selection with dropdown spinners.
...
}`,...U.parameters?.docs?.source}}};const ze=["Default","WithLabel","WithDefaultValue","TwelveHourFormat","TwentyFourHourFormat","WithPlaceholder","Required","Disabled","WithMinTime","WithMaxTime","TimeRange","WithInterval","WithError","SmallSize","LargeSize","AppointmentScheduler","ShiftScheduler","ReminderTime","MeetingPlanner"];export{O as AppointmentScheduler,N as Default,D as Disabled,F as LargeSize,U as MeetingPlanner,Y as ReminderTime,$ as Required,L as ShiftScheduler,B as SmallSize,V as TimeRange,A as TwelveHourFormat,R as TwentyFourHourFormat,q as WithDefaultValue,E as WithError,_ as WithInterval,z as WithLabel,I as WithMaxTime,H as WithMinTime,W as WithPlaceholder,ze as __namedExportsOrder,Ne as default};
