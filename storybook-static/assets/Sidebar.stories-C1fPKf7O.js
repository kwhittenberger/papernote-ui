import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as I}from"./iframe-BGnfALfv.js";import{C as W}from"./chevron-down-DJ26yXSb.js";import{C as z}from"./chevron-right-DUZ-anT2.js";import{H as b}from"./house-CeG5UKnZ.js";import{U as w}from"./users-Cxf11A3U.js";import{c as U}from"./createLucideIcon-CUwsy_KF.js";import{F as N}from"./file-text-BV-dprxI.js";import{S as v}from"./settings-BGdafNMi.js";import{B as V}from"./bell-BbMkcgHU.js";import{L as q}from"./log-out-B1a42N_b.js";import{C as E}from"./circle-question-mark-DO9MAp_m.js";import"./preload-helper-PPVm8Dsz.js";const O=[["path",{d:"M5 21v-6",key:"1hz6c0"}],["path",{d:"M12 21V9",key:"uvy0l4"}],["path",{d:"M19 21V3",key:"11j9sm"}]],S=U("chart-no-axes-column-increasing",O);function g({item:r,onNavigate:i,level:t=0,currentPath:s}){const a=r.children&&r.children.length>0,o=s&&r.href?s===r.href:r.active,n=a&&s?r.children?.some(d=>s===d.href||s?.startsWith(d.href||"")):!1,l=n||a&&s?.startsWith(r.href||""),[y,D]=I.useState(l),_=()=>{a?D(!y):r.href?i?.(r.href,r.external):r.onClick&&r.onClick()},P=t===0?"pl-3":t===1?"pl-8":"pl-12",B=o,R=n&&!o;return e.jsxs("div",{children:[e.jsxs("button",{onClick:_,className:`
          w-full flex items-center justify-between py-2 text-sm transition-colors
          ${B?t>0?"bg-accent-100 text-accent-900 font-medium rounded-lg border-l-2 border-accent-500":"bg-accent-50 text-accent-900 font-medium rounded-lg":R?"text-ink-900 rounded-lg":t>0?"text-ink-600 hover:text-ink-900 hover:bg-paper-50 rounded-lg transition-colors":"text-ink-600 hover:text-ink-900 hover:bg-paper-100 rounded-lg transition-colors"}
          ${P} pr-3
        `,children:[e.jsxs("div",{className:"flex items-center gap-3 min-w-0 flex-1",children:[r.icon&&e.jsx("span",{className:"flex-shrink-0 w-5 h-5 flex items-center justify-center text-ink-500",children:r.icon}),e.jsx("span",{className:"truncate",children:r.label}),r.badge&&e.jsx("span",{className:"ml-auto flex-shrink-0 px-2 py-0.5 text-xs font-medium bg-accent-100 text-accent-700 rounded-full",children:r.badge})]}),a&&e.jsx("span",{className:"flex-shrink-0 ml-2",children:y?e.jsx(W,{className:"h-4 w-4 text-ink-400"}):e.jsx(z,{className:"h-4 w-4 text-ink-400"})})]}),a&&y&&e.jsx("div",{className:"mt-1 space-y-1",children:r.children?.map(d=>e.jsx(g,{item:d,onNavigate:i,level:t+1,currentPath:s},d.id))})]})}function k({title:r,items:i,onNavigate:t,defaultExpanded:s=!0,currentPath:a}){const[o,n]=I.useState(s);return r?e.jsxs("div",{children:[e.jsxs("button",{onClick:()=>n(!o),className:"w-full flex items-center justify-between px-3 py-2 text-xs font-semibold text-ink-500 uppercase tracking-wider hover:text-ink-700 transition-colors",children:[e.jsx("span",{children:r}),o?e.jsx(W,{className:"h-4 w-4"}):e.jsx(z,{className:"h-4 w-4"})]}),o&&e.jsx("div",{className:"mt-1 space-y-1",children:i.map(l=>e.jsx(g,{item:l,onNavigate:t,currentPath:a},l.id))})]}):e.jsx("div",{className:"space-y-1",children:i.map(l=>e.jsx(g,{item:l,onNavigate:t,currentPath:a},l.id))})}function j({items:r,onNavigate:i,className:t="",header:s,footer:a,currentPath:o}){return e.jsxs("div",{className:`flex flex-col h-full bg-white border-r border-paper-300 notebook-binding ${t}`,children:[s&&e.jsx("div",{className:"px-6 pt-6 pb-4",children:s}),e.jsx("nav",{className:"flex-1 px-3 py-2 space-y-1 overflow-y-auto",children:r.map(n=>n.separator?e.jsx("div",{className:"my-4 border-t border-paper-300"},n.id):e.jsx(g,{item:n,onNavigate:i,currentPath:o},n.id))}),a&&e.jsx("div",{className:"border-t border-paper-300 pl-2 pr-6 py-4 overflow-visible",children:a})]})}try{k.displayName="SidebarGroup",k.__docgenInfo={description:"",displayName:"SidebarGroup",props:{title:{defaultValue:null,description:"",name:"title",required:!1,type:{name:"string"}},items:{defaultValue:null,description:"",name:"items",required:!0,type:{name:"SidebarItem[]"}},onNavigate:{defaultValue:null,description:"",name:"onNavigate",required:!1,type:{name:"((href: string, external?: boolean) => void)"}},defaultExpanded:{defaultValue:{value:"true"},description:"",name:"defaultExpanded",required:!1,type:{name:"boolean"}},currentPath:{defaultValue:null,description:"",name:"currentPath",required:!1,type:{name:"string"}}}}}catch{}try{j.displayName="Sidebar",j.__docgenInfo={description:"",displayName:"Sidebar",props:{items:{defaultValue:null,description:"",name:"items",required:!0,type:{name:"SidebarItem[]"}},onNavigate:{defaultValue:null,description:"",name:"onNavigate",required:!1,type:{name:"((href: string, external?: boolean) => void)"}},className:{defaultValue:{value:""},description:"",name:"className",required:!1,type:{name:"string"}},header:{defaultValue:null,description:"",name:"header",required:!1,type:{name:"ReactNode"}},footer:{defaultValue:null,description:"",name:"footer",required:!1,type:{name:"ReactNode"}},currentPath:{defaultValue:null,description:"",name:"currentPath",required:!1,type:{name:"string"}}}}}catch{}const re={title:"Layout/Sidebar",component:j,parameters:{layout:"fullscreen"},tags:["autodocs"],decorators:[r=>e.jsxs("div",{style:{display:"flex",height:"600px",border:"1px solid #e5e5e5"},children:[e.jsx(r,{}),e.jsxs("div",{style:{flex:1,padding:"2rem",backgroundColor:"#fafaf9"},children:[e.jsx("h2",{children:"Main Content Area"}),e.jsx("p",{children:"This is where your page content would appear."})]})]})]},C=[{id:"1",label:"Dashboard",icon:e.jsx(b,{className:"h-5 w-5"}),href:"/dashboard"},{id:"2",label:"Users",icon:e.jsx(w,{className:"h-5 w-5"}),href:"/users"},{id:"3",label:"Reports",icon:e.jsx(S,{className:"h-5 w-5"}),href:"/reports"},{id:"4",label:"Documents",icon:e.jsx(N,{className:"h-5 w-5"}),href:"/documents"},{id:"5",label:"Settings",icon:e.jsx(v,{className:"h-5 w-5"}),href:"/settings"}],H=[{id:"1",label:"Dashboard",icon:e.jsx(b,{className:"h-5 w-5"}),href:"/dashboard"},{id:"2",label:"Notifications",icon:e.jsx(V,{className:"h-5 w-5"}),href:"/notifications",badge:5},{id:"3",label:"Messages",icon:e.jsx(N,{className:"h-5 w-5"}),href:"/messages",badge:12},{id:"4",label:"Settings",icon:e.jsx(v,{className:"h-5 w-5"}),href:"/settings"}],A=[{id:"1",label:"Dashboard",icon:e.jsx(b,{className:"h-5 w-5"}),href:"/dashboard",active:!0},{id:"2",label:"Users",icon:e.jsx(w,{className:"h-5 w-5"}),children:[{id:"2-1",label:"All Users",href:"/users/all"},{id:"2-2",label:"Active Users",href:"/users/active"},{id:"2-3",label:"Inactive Users",href:"/users/inactive"}]},{id:"3",label:"Reports",icon:e.jsx(S,{className:"h-5 w-5"}),children:[{id:"3-1",label:"Sales",href:"/reports/sales"},{id:"3-2",label:"Analytics",href:"/reports/analytics"},{id:"3-3",label:"Performance",href:"/reports/performance"}]},{id:"4",label:"Settings",icon:e.jsx(v,{className:"h-5 w-5"}),href:"/settings"}],c={args:{items:C,currentPath:"/dashboard"}},h={args:{items:H,currentPath:"/dashboard"}},m={args:{items:A,currentPath:"/dashboard"}},p={args:{items:C,currentPath:"/users",header:e.jsxs("div",{style:{padding:"1rem",borderBottom:"1px solid #e5e5e5"},children:[e.jsx("h2",{style:{fontSize:"1.25rem",fontWeight:600,color:"#0f172a"},children:"My App"}),e.jsx("p",{style:{fontSize:"0.875rem",color:"#64748b"},children:"v1.0.0"})]}),footer:e.jsxs("div",{style:{padding:"1rem",borderTop:"1px solid #e5e5e5"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.75rem",marginBottom:"0.5rem"},children:[e.jsx("div",{style:{width:"32px",height:"32px",borderRadius:"50%",backgroundColor:"#e5e5e5",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"0.875rem",fontWeight:600},children:"JD"}),e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"0.875rem",fontWeight:500},children:"John Doe"}),e.jsx("div",{style:{fontSize:"0.75rem",color:"#64748b"},children:"john@example.com"})]})]}),e.jsxs("button",{style:{width:"100%",display:"flex",alignItems:"center",gap:"0.5rem",padding:"0.5rem",fontSize:"0.875rem",color:"#64748b",border:"none",background:"transparent",borderRadius:"0.375rem",cursor:"pointer"},children:[e.jsx(q,{className:"h-4 w-4"}),"Sign Out"]})]})}},f={args:{items:A,currentPath:"/users/active"}},u={args:{items:C,currentPath:"/reports",onNavigate:(r,i)=>{alert(`Navigate to: ${r}${i?" (external)":""}`)}}},x={args:{items:[{id:"1",label:"Dashboard",icon:e.jsx(b,{className:"h-5 w-5"}),href:"/dashboard"},{id:"2",label:"Users",icon:e.jsx(w,{className:"h-5 w-5"}),badge:24,children:[{id:"2-1",label:"All Users",href:"/users/all"},{id:"2-2",label:"Active Users",href:"/users/active",badge:18},{id:"2-3",label:"Pending",href:"/users/pending",badge:6}]},{id:"3",label:"Reports",icon:e.jsx(S,{className:"h-5 w-5"}),children:[{id:"3-1",label:"Sales",href:"/reports/sales"},{id:"3-2",label:"Analytics",href:"/reports/analytics"}]},{id:"4",label:"Documents",icon:e.jsx(N,{className:"h-5 w-5"}),href:"/documents"},{id:"sep",label:"",separator:!0},{id:"5",label:"Help",icon:e.jsx(E,{className:"h-5 w-5"}),href:"/help"},{id:"6",label:"Settings",icon:e.jsx(v,{className:"h-5 w-5"}),href:"/settings"}],currentPath:"/users/active",header:e.jsx("div",{style:{padding:"1.5rem 1rem",borderBottom:"1px solid #e5e5e5"},children:e.jsx("h2",{style:{fontSize:"1.5rem",fontWeight:700,color:"#0f172a"},children:"PaperNote"})}),footer:e.jsx("div",{style:{padding:"1rem",borderTop:"1px solid #e5e5e5"},children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.75rem"},children:[e.jsx("div",{style:{width:"36px",height:"36px",borderRadius:"50%",backgroundColor:"#3b82f6",color:"white",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"0.875rem",fontWeight:600},children:"JD"}),e.jsxs("div",{style:{flex:1,minWidth:0},children:[e.jsx("div",{style:{fontSize:"0.875rem",fontWeight:500,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:"John Doe"}),e.jsx("div",{style:{fontSize:"0.75rem",color:"#64748b",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:"john@example.com"})]})]})})}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    items: basicItems,
