import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as i}from"./iframe-CJgaPZSw.js";import{C as B}from"./chevron-down-BjhK3UY1.js";import{C as O}from"./chevron-right-CLU9-iXK.js";import{F as f}from"./file-text-DDF_eTix.js";import{c as v}from"./createLucideIcon-CsANJayS.js";import{I as c,M as j,V as k}from"./video-BZrpUCGe.js";import"./preload-helper-PPVm8Dsz.js";const _=[["rect",{width:"20",height:"5",x:"2",y:"3",rx:"1",key:"1wp1u1"}],["path",{d:"M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8",key:"1s80jp"}],["path",{d:"M10 12h4",key:"a56b0p"}]],P=v("archive",_);const R=[["path",{d:"m16 18 6-6-6-6",key:"eg8j8"}],["path",{d:"m8 6-6 6 6 6",key:"ppft3o"}]],N=v("code",R);const q=[["path",{d:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z",key:"1kt360"}]],n=v("folder",q);function t({data:l,onSelect:a,selectedId:d,defaultExpanded:V=[],showLines:y=!1,expandIcon:F,collapseIcon:L}){const[T,W]=i.useState(new Set(V)),M=s=>{const r=new Set(T);r.has(s)?r.delete(s):r.add(s),W(r)},D=(s,r=0)=>{const I=s.children&&s.children.length>0,E=T.has(s.id),A=d===s.id;return e.jsxs("div",{children:[e.jsxs("div",{className:`
...
}`,...w.parameters?.docs?.source}}};const Y=["Default","WithIcons","WithLines","DefaultExpanded","WithDisabledNodes","FileExplorer","OrganizationChart","CategoryNavigation","MediaLibrary","DocumentStructure"];export{x as CategoryNavigation,o as Default,p as DefaultExpanded,w as DocumentStructure,b as FileExplorer,S as MediaLibrary,g as OrganizationChart,u as WithDisabledNodes,h as WithIcons,m as WithLines,Y as __namedExportsOrder,X as default};
