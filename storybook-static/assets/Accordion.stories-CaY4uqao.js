import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as w}from"./iframe-C8OopBmF.js";import{C as v}from"./chevron-down-Ct6Hndhd.js";import{M as W}from"./minus-C6yMlFwf.js";import{P as k}from"./plus-fyjuMsjz.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-D9MvcA__.js";function i({items:r,allowMultiple:o=!1,defaultOpen:S=[],onChange:I,expandIcon:y,collapseIcon:f,showStepNumbers:b=!1}){const[j,C]=w.useState(new Set(S)),E=t=>{const n=new Set(j);n.has(t)?n.delete(t):(o||n.clear(),n.add(t)),C(n),I?.(Array.from(n))};return e.jsx("div",{className:"space-y-2",children:r.map((t,n)=>{const s=j.has(t.id),D=n+1;return e.jsxs("div",{className:"bg-white bg-subtle-grain border border-paper-200 rounded-lg overflow-hidden transition-all duration-200",children:[e.jsxs("button",{onClick:()=>!t.disabled&&E(t.id),disabled:t.disabled,className:`
