import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as d}from"./iframe-C8OopBmF.js";import{C as N}from"./check-f1fl1XmI.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-D9MvcA__.js";function p({steps:t,activeStep:o,completedSteps:r=[],orientation:c="horizontal",clickable:n=!1,onStepClick:i}){const m=t.findIndex(s=>s.id===o),A=(s,a)=>{const u=s.id===o,S=r.includes(s.id),l=n&&i,R=a===t.length-1;return e.jsxs("div",{className:`
