import{j as s}from"./jsx-runtime-u17CrQMm.js";import{r as n}from"./iframe-CJgaPZSw.js";import{M as q}from"./minus-DbYubAIX.js";import{C as F}from"./check-bgZ_5cT5.js";import{F as v}from"./file-text-DDF_eTix.js";import{I as P,M as _,V as B}from"./video-BZrpUCGe.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-CsANJayS.js";const a=n.forwardRef(({checked:e,onChange:c,label:t,description:o,disabled:r=!1,indeterminate:b=!1,className:I="",id:N,name:w,icon:y},D)=>{const V=n.useId(),C=N||V,j=o?`${C}-desc`:void 0,A=()=>{r||c(!e)},W=S=>{S.key===" "&&!r&&(S.preventDefault(),c(!e))};return s.jsxs("label",{htmlFor:C,className:`flex items-start gap-3 ${r?"opacity-40 cursor-not-allowed":"cursor-pointer"} ${I}`,children:[s.jsxs("div",{className:"relative inline-block flex-shrink-0 mt-0.5",children:[s.jsx("input",{ref:D,type:"checkbox",id:C,name:w,checked:e,onChange:A,onKeyDown:W,disabled:r,className:"sr-only","aria-checked":b?"mixed":e,"aria-describedby":j,"aria-disabled":r}),s.jsx("div",{className:`
          ...
          `,children:b?s.jsx(q,{className:"h-3 w-3 text-white"}):e?s.jsx(F,{className:"h-3 w-3 text-white"}):null})]}),(t||o)&&s.jsxs("div",{className:"flex-1",children:[t&&s.jsxs("div",{className:"flex items-center gap-2",children:[y&&s.jsx("span",{className:"text-ink-700",children:y}),s.jsx("p",{className:"text-sm font-medium text-ink-900",children:t})]}),o&&s.jsx("p",{id:j,className:"text-xs text-ink-600 mt-0.5",children:o})]})]})});a.displayName="Checkbox";try{a.displayName="Checkbox",a.__docgenInfo={description:"",displayName:"Checkbox",props:{checked:{defaultValue:null,description:"",name:"checked",required:!0,type:{name:"boolean"}},onChange:{defaultValue:null,description:"",name:"onChange",required:!0,type:{name:"(checked: boolean) => void"}},label:{defaultValue:null,description:"",name:"label",required:!1,type:{name:"string"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},disabled:{defaultValue:{value:"false"},description:"",name:"disabled",required:!1,type:{name:"boolean"}},indeterminate:{defaultValue:{value:"false"},description:"",name:"indeterminate",required:!1,type:{name:"boolean"}},className:{defaultValue:{value:""},description:"",name:"className",required:!1,type:{name:"string"}},id:{defaultValue:null,description:"",name:"id",required:!1,type:{name:"string"}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string"}},icon:{defaultValue:null,description:"Optional icon to display next to label",name:"icon",required:!1,type:{name:"ReactNode"}}}}}catch{}const G={title:"Forms/Checkbox",component:a,parameters:{layout:"centered"},tags:["autodocs"],decorators:[e=>s.jsx("div",{style:{minWidth:"400px"},children:s.jsx(e,{})})],argTypes:{size:{control:"select",options:["sm","md","lg"]}}},l={render:()=>{const[e,c]=n.useState(!1);return s.jsx(a,{checked:e,onChange:c})}},d={render:()=>{const[e,c]=n.useState(!1);return s.jsx(a,{checked:e,onChange:c,label:"I agree to the terms and conditions"})}},i={render:()=>{const[e,c]=n.useState(!0);return s.jsx(a,{checked:e,onChange:c,label:"Subscribed to newsletter"})}},m={render:()=>s.jsx(a,{checked:!1,onChange:()=>{},disabled:!0,label:"Disabled checkbox"})},h={render:()=>s.jsx(a,{checked:!0,onChange:()=>{},disabled:!0,label:"Disabled (checked)"})},u={render:()=>{const[e,c]=n.useState(!1);return s.jsx(a,{checked:e,onChange:c,label:"Accept terms and conditions",icon:s.jsx(v,{className:"h-4 w-4"})})}},k={render:()=>{const[e,c]=n.useState(!1);return s.jsx(a,{checked:e,onChange:c,size:"sm",label:"Small checkbox"})}},p={render:()=>{const[e,c]=n.useState(!1);return s.jsx(a,{checked:e,onChange:c,size:"lg",label:"Large checkbox"})}},f={render:()=>{const[e,c]=n.useState({notifications:!0,emails:!1,updates:!0,marketing:!1});return s.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.75rem"},children:[s.jsx("h4",{style:{marginBottom:"0.5rem",fontWeight:600},children:"Email Preferences"}),s.jsx(a,{checked:e.notifications,onChange:t=>c({...e,notifications:t}),label:"Notification emails"}),s.jsx(a,{checked:e.emails,onChange:t=>c({...e,emails:t}),label:"Account emails"}),s.jsx(a,{checked:e.updates,onChange:t=>c({...e,updates:t}),label:"Product updates"}),s.jsx(a,{checked:e.marketing,onChange:t=>c({...e,marketing:t}),label:"Marketing emails"})]})}},g={render:()=>{const[e,c]=n.useState({documents:!1,images:!1,audio:!1,video:!1});return s.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.75rem"},children:[s.jsx("h4",{style:{marginBottom:"0.5rem",fontWeight:600},children:"Select File Types"}),s.jsx(a,{checked:e.documents,onChange:t=>c({...e,documents:t}),label:"Documents (.pdf, .doc, .txt)",icon:s.jsx(v,{className:"h-4 w-4"})}),s.jsx(a,{checked:e.images,onChange:t=>c({...e,images:t}),label:"Images (.jpg, .png, .gif)",icon:s.jsx(P,{className:"h-4 w-4"})}),s.jsx(a,{checked:e.audio,onChange:t=>c({...e,audio:t}),label:"Audio (.mp3, .wav, .flac)",icon:s.jsx(_,{className:"h-4 w-4"})}),s.jsx(a,{checked:e.video,onChange:t=>c({...e,video:t}),label:"Video (.mp4, .avi, .mov)",icon:s.jsx(B,{className:"h-4 w-4"})})]})}},x={render:()=>{const[e,c]=n.useState({item1:!1,item2:!1,item3:!1,item4:!1}),t=Object.values(e).every(Boolean);Object.values(e).some(Boolean);const o=r=>{c({item1:r,item2:r,item3:r,item4:r})};return s.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.75rem"},children:[s.jsx(a,{checked:t,onChange:o,label:"Select All",style:{fontWeight:600}}),s.jsxs("div",{style:{marginLeft:"1.5rem",display:"flex",flexDirection:"column",gap:"0.5rem"},children:[s.jsx(a,{checked:e.item1,onChange:r=>c({...e,item1:r}),label:"Item 1"}),s.jsx(a,{checked:e.item2,onChange:r=>c({...e,item2:r}),label:"Item 2"}),s.jsx(a,{checked:e.item3,onChange:r=>c({...e,item3:r}),label:"Item 3"}),s.jsx(a,{checked:e.item4,onChange:r=>c({...e,item4:r}),label:"Item 4"})]})]})}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...x.parameters?.docs?.source}}};const K=["Default","WithLabel","Checked","Disabled","DisabledChecked","WithIcon","Small","Large","CheckboxGroup","FileTypes","SelectAll"];export{f as CheckboxGroup,i as Checked,l as Default,m as Disabled,h as DisabledChecked,g as FileTypes,p as Large,x as SelectAll,k as Small,u as WithIcon,d as WithLabel,K as __namedExportsOrder,G as default};
