import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as s}from"./iframe-BXYHkhYr.js";import{c as N}from"./createLucideIcon-D6fSB1ZX.js";import{S}from"./settings-gzCitmau.js";import{B as U}from"./bell-mXRvDIZR.js";import{L as $}from"./lock-BfKhaX8C.js";import"./preload-helper-PPVm8Dsz.js";const P=[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]],A=N("user",P);function r({tabs:t,defaultTab:n,variant:o="underline",orientation:i="horizontal",size:c="md",onChange:C}){const[d,w]=s.useState(n||t[0]?.id),W=a=>{w(a),C?.(a)},l={sm:{padding:"px-3 py-1.5",text:"text-xs",icon:"h-3.5 w-3.5",gap:i==="vertical"?"gap-1.5":"gap-4",minWidth:i==="vertical"?"min-w-[150px]":"",spacing:"mt-4"},md:{padding:"px-4 py-2.5",text:"text-sm",icon:"h-4 w-4",gap:i==="vertical"?"gap-2":"gap-6",minWidth:i==="vertical"?"min-w-[200px]":"",spacing:"mt-6"},lg:{padding:"px-5 py-3",text:"text-base",icon:"h-5 w-5",gap:i==="vertical"?"gap-3":"gap-8",minWidth:i==="vertical"?"min-w-[250px]":"",spacing:"mt-8"}};return e.jsxs("div",{className:`w-full ${i==="vertical"?`flex ${l[c].gap}`:""}`,children:[e.jsx("div",{className:`
...
}`,...f.parameters?.docs?.source}}};const E=["Default","Underline","Pill","WithIcons","WithBadges","WithDisabledTab","Vertical","VerticalUnderline","Complete"];export{f as Complete,p as Default,b as Pill,m as Underline,h as Vertical,x as VerticalUnderline,g as WithBadges,u as WithDisabledTab,v as WithIcons,E as __namedExportsOrder,D as default};
