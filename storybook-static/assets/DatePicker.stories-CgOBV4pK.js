import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as o}from"./iframe-BGnfALfv.js";import{X as ye}from"./x-BG-wDY58.js";import{c as xe}from"./createLucideIcon-CUwsy_KF.js";import{C as ve}from"./chevron-left-CHh6LlNW.js";import{C as be}from"./chevron-right-DUZ-anT2.js";import"./preload-helper-PPVm8Dsz.js";const Se=[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]],ke=xe("calendar",Se),we=["Su","Mo","Tu","We","Th","Fr","Sa"],Ce=["January","February","March","April","May","June","July","August","September","October","November","December"],i=o.forwardRef(({value:t,onChange:r,label:s,placeholder:d="Select date",minDate:h,maxDate:p,disabledDates:x,locale:$="en-US",format:te="medium",validationState:f,validationMessage:v,helperText:A,required:ae=!1,disabled:b=!1,showTodayButton:H=!0,showClearButton:R=!0,className:re="",size:Y="md"},ne)=>{const[D,c]=o.useState(!1),[u,S]=o.useState(t||new Date),L=o.useRef(null),k=o.useRef(null),J=o.useId(),K=o.useId(),X=o.useId();o.useImperativeHandle(ne,()=>({focus:()=>k.current?.focus(),blur:()=>k.current?.blur(),open:()=>c(!0),close:()=>c(!1)})),o.useEffect(()=>{const a=n=>{L.current&&!L.current.contains(n.target)&&c(!1)};return D&&document.addEventListener("mousedown",a),()=>{document.removeEventListener("mousedown",a)}},[D]),o.useEffect(()=>{t&&S(t)},[t]);const se=a=>{if(!a)return"";let n;switch(te){case"short":n={month:"numeric",day:"numeric",year:"numeric"};break;case"medium":n={month:"short",day:"numeric",year:"numeric"};break;case"long":n={month:"long",day:"numeric",year:"numeric"};break;default:n={month:"short",day:"numeric",year:"numeric"}}return new Intl.DateTimeFormat($,n).format(a)},U=a=>h&&a<new Date(h.setHours(0,0,0,0))||p&&a>new Date(p.setHours(23,59,59,999))?!0:x?Array.isArray(x)?x.some(n=>n.getFullYear()===a.getFullYear()&&n.getMonth()===a.getMonth()&&n.getDate()===a.getDate()):x(a):!1,G=(a,n)=>a?a.getFullYear()===n.getFullYear()&&a.getMonth()===n.getMonth()&&a.getDate()===n.getDate():!1,oe=a=>G(new Date,a),Q=(a,n)=>new Date(a,n+1,0).getDate(),ie=(a,n)=>new Date(a,n,1).getDay(),de=()=>{const a=u.getFullYear(),n=u.getMonth(),_=Q(a,n),g=ie(a,n),y=Q(a,n-1),m=[];for(let l=g-1;l>=0;l--)m.push({date:new Date(a,n-1,y-l),isCurrentMonth:!1});for(let l=1;l<=_;l++)m.push({date:new Date(a,n,l),isCurrentMonth:!0});const ge=42-m.length;for(let l=1;l<=ge;l++)m.push({date:new Date(a,n+1,l),isCurrentMonth:!1});return m},le=()=>{S(new Date(u.getFullYear(),u.getMonth()-1,1))},ce=()=>{S(new Date(u.getFullYear(),u.getMonth()+1,1))},ue=a=>{U(a)||(r?.(a),c(!1))},me=()=>{const a=new Date;U(a)||(r?.(a),S(a),c(!1))},Z=()=>{r?.(null)},pe=a=>{a.key==="Escape"?(c(!1),k.current?.focus()):a.key==="Enter"&&!D&&c(!0)},De={sm:"text-sm py-1.5 px-3",md:"text-sm py-2 px-3",lg:"text-base py-2.5 px-4"},ee={sm:"h-4 w-4",md:"h-4 w-4",lg:"h-5 w-5"},he={error:"border-error-500 focus:ring-error-500 focus:border-error-500",success:"border-success-500 focus:ring-success-500 focus:border-success-500",warning:"border-warning-500 focus:ring-warning-500 focus:border-warning-500"},fe={error:"text-error-600",success:"text-success-600",warning:"text-warning-600"};return e.jsxs("div",{className:`relative ${re}`,ref:L,children:[s&&e.jsxs("label",{id:J,className:"block text-sm font-medium text-ink-700 mb-1",children:[s,ae&&e.jsx("span",{className:"text-error-500 ml-1",children:"*"})]}),e.jsxs("div",{className:"relative",children:[e.jsx("input",{ref:k,type:"text",readOnly:!0,value:se(t||null),placeholder:d,onClick:()=>!b&&c(!D),onKeyDown:pe,disabled:b,className:`
            ...
            pr-10
          `,"aria-labelledby":s?J:void 0,"aria-label":s?void 0:"Date picker","aria-expanded":D,"aria-haspopup":"dialog","aria-controls":K,"aria-invalid":f==="error"?"true":void 0,"aria-describedby":v?X:void 0,role:"combobox"}),e.jsxs("div",{className:"absolute inset-y-0 right-0 flex items-center pr-3 gap-1",children:[R&&t&&!b&&e.jsx("button",{type:"button",onClick:a=>{a.stopPropagation(),Z()},className:"text-ink-400 hover:text-ink-600 focus:outline-none","aria-label":"Clear date",children:e.jsx(ye,{className:ee[Y]})}),e.jsx(ke,{className:`${ee[Y]} text-ink-400`})]})]}),v&&e.jsx("p",{id:X,className:`mt-1 text-xs ${f?fe[f]:"text-ink-500"}`,role:"alert","aria-live":"polite",children:v}),A&&!v&&e.jsx("p",{className:"mt-1 text-xs text-ink-500",children:A}),D&&e.jsxs("div",{id:K,className:"absolute z-50 mt-1 bg-white rounded-lg shadow-lg border border-paper-200 p-3 w-72",role:"dialog","aria-modal":"true","aria-label":"Date picker calendar",children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsx("button",{type:"button",onClick:le,className:"p-1 rounded hover:bg-paper-100 text-ink-600 hover:text-ink-900","aria-label":"Previous month",children:e.jsx(ve,{className:"h-5 w-5"})}),e.jsxs("span",{className:"text-sm font-semibold text-ink-900",children:[Ce[u.getMonth()]," ",u.getFullYear()]}),e.jsx("button",{type:"button",onClick:ce,className:"p-1 rounded hover:bg-paper-100 text-ink-600 hover:text-ink-900","aria-label":"Next month",children:e.jsx(be,{className:"h-5 w-5"})})]}),e.jsx("div",{className:"grid grid-cols-7 mb-1",children:we.map(a=>e.jsx("div",{className:"text-center text-xs font-medium text-ink-500 py-1",children:a},a))}),e.jsx("div",{className:"grid grid-cols-7",children:de().map(({date:a,isCurrentMonth:n},_)=>{const g=U(a),y=G(t||null,a),m=oe(a);return e.jsx("button",{type:"button",onClick:()=>ue(a),disabled:g,className:`
...
}`,...B.parameters?.docs?.source}}};const Ee=["Default","WithLabel","WithPlaceholder","WithDefaultValue","Required","Disabled","WithMinDate","WithMaxDate","DateRange","WithError","SmallSize","LargeSize","BookingForm","BirthdayPicker","EventScheduler","DeadlinePicker"];export{O as BirthdayPicker,F as BookingForm,z as DateRange,B as DeadlinePicker,w as Default,N as Disabled,W as EventScheduler,V as LargeSize,T as Required,E as SmallSize,M as WithDefaultValue,I as WithError,C as WithLabel,q as WithMaxDate,P as WithMinDate,j as WithPlaceholder,Ee as __namedExportsOrder,Ie as default};
