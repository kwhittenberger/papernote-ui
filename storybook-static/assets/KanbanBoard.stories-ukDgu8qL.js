import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as a}from"./iframe-BKwLVrTx.js";import{E}from"./ellipsis-vertical-DIoVGTvd.js";import{P as O}from"./plus-CWwp3ewM.js";import{U as V}from"./user-C4Ma2TEq.js";import"./preload-helper-PPVm8Dsz.js";import"./createLucideIcon-BYzyF8e7.js";function s({columns:r,onChange:i,onCardClick:t,onAddCard:k,onColumnMenu:B,renderCard:D,showAddButton:N=!0,className:A=""}){const[S,j]=a.useState(null),[I,w]=a.useState(null),P=(n,d)=>{j({card:n,columnId:d})},T=(n,d)=>{n.preventDefault(),w(d)},W=()=>{w(null)},z=(n,d)=>{if(n.preventDefault(),w(null),!S)return;const{card:c,columnId:o}=S;if(o===d){j(null);return}const L=r.map(l=>l.id===o?{...l,cards:l.cards.filter(M=>M.id!==c.id)}:l.id===d?{...l,cards:[...l.cards,c]}:l);i(L),j(null)},R={low:"bg-success-100 text-success-700",medium:"bg-warning-100 text-warning-700",high:"bg-error-100 text-error-700"},K=n=>e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-start justify-between gap-2",children:[e.jsx("h4",{className:"text-sm font-semibold text-ink-900 flex-1",children:n.title}),n.priority&&e.jsx("span",{className:`
