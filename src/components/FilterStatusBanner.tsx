...
export function FilterStatusBanner({
  ...
  return (
    <div className={`mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200 ${className}`}>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 text-sm text-blue-800 flex-wrap">
          ...
          <div className="flex flex-wrap gap-1">
            {activeFilters.map((filter) => (
              <span 
                key={filter.key} 
                className="inline-flex items-center gap-1 px-2 py-1 bg-blue-100 rounded text-xs"
              >
        ...
        {(resultCount !== undefined || totalCount !== undefined) && (
          <div className="text-sm font-medium text-blue-800 flex-shrink-0">
            {resultCount !== undefined && totalCount !== undefined
